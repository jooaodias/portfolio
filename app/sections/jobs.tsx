...
export function Jobs() {
    ...
    return (
        <div id="jobs" className="flex flex-col justify-start items-start w-full max-w-4xl mx-auto px-4 pb-2 pt-10">
            <AnimatedContent delay={0} duration={0.6}>
                <div className="flex items-center gap-3 mb-6">
                    <h2 className="text-2xl font-bold text-white">{t('jobs.title')}</h2>
                </div>
            </AnimatedContent>
